...
var BooksController = function () {
    var _classDecorators = [(0, common_1.Controller)('/api/books')];
    ...
    var BooksController = _classThis = /** @class */ (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.booksService.create(createBookDto)];
                        case 1:
                            book = _a.sent();
                            return [2 /*return*/, book];
                        case 2:
                            error_1 = _a.sent();
                            console.error('Error creating book:', error_1.message || error_1);
                            throw new common_1.HttpException({
                                error: error_1.message || 'Error creating book',
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.booksService.findOne(id)];
                        case 1:
                            bookData = _a.sent();
                            return [2 /*return*/, bookData];
                        case 2:
                            error_2 = _a.sent();
                            console.error('Error getting book:', error_2.message || error_2);
                            throw new common_1.HttpException({
                                error: error_2.message || 'Error getting book',
        ...
        BooksController_1.prototype.remove = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.booksService.remove(id)];
                        case 1:
                            result = _a.sent();
                            if (!result) {
                                throw new common_1.NotFoundException("BOOK WITH ID ".concat(id, " NOT FOUND"));
                            }
                            return [2 /*return*/, { message: "BOOK WITH ID ".concat(id, " SUCCESSFULLY DELETED") }];
                    }
                });
            });
        };
